...
# A Vercel Function can only write below /tmp. Local deployments keep their
# durable SQLite database and current spreadsheet in the repository data dir.
DATA = Path("/tmp/ordenador-orcamentos") if os.getenv("VERCEL") else ROOT / "data"
